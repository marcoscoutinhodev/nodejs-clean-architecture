...
const makeLoadUserByEmailRepositoryWithErrors = () => {
    class LoadUserByEmailRepositorySpy {
        async load () {
            throw new Error();
        }
...
const makeTokenGeneratorWithErrors = () => {
    class TokenGeneratorSpy {
        async generate () {
            throw new Error();
        }
...
const makeUpdateAccessTokenRepositoryWithErrors = () => {
    class UpdateAccessTokenRepositorySpy {
        async update () {
            throw new Error();
        }
...
describe("Auth UseCase", () => {
    ...
    test("Should throw if any dependency throws", async () => {
        ...
        const suts = [].concat(
            new AuthUseCase({
                loadUserByEmailRepository: makeLoadUserByEmailRepositoryWithErrors(),
            }),
            new AuthUseCase({
                loadUserByEmailRepository,
                encrypter: makeEncrypterWithErrors(),
            }),
            new AuthUseCase({
                loadUserByEmailRepository,
                encrypter,
                tokenGenerator: makeTokenGeneratorWithErrors(),
            }),
            new AuthUseCase({
                loadUserByEmailRepository,
                encrypter,
            ...
            new AuthUseCase({
                ...
                encrypter,
                tokenGenerator,
                updateAccessTokenRepository: makeUpdateAccessTokenRepositoryWithErrors(),
            })
        );
